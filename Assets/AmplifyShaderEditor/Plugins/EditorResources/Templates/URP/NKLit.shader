Shader /*ase_name*/ "Hidden/Universal/NKLit" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Port:Forward:Emission
				On:SetDefine:Forward:pragma shader_feature_local_fragment _EMISSION
				On:SetDefine:GBuffer:pragma shader_feature_local_fragment _EMISSION
				On:SetDefine:Meta:pragma shader_feature_local_fragment _EMISSION
			Port:Forward:Baked GI
				On:SetDefine:ASE_BAKEDGI 1
			Port:Forward:Alpha Clip Threshold
				On:SetDefine:Forward:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:ShadowCaster:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:GBuffer:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:DepthOnly:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:DepthNormals:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:Meta:pragma shader_feature_local_fragment _ALPHATEST_ON
				On:SetDefine:Universal2D:pragma shader_feature_local_fragment _ALPHATEST_ON
			Port:Forward:Alpha Clip Threshold Shadow
				...
				On:SetDefine:Universal2D:pragma shader_feature_local_fragment _ALPHATEST_ON
			Port:Forward:Normal
				On:SetDefine:Forward:pragma shader_feature_local _NORMALMAP
				On:SetDefine:GBuffer:pragma shader_feature_local _NORMALMAP
				On:SetDefine:DepthNormals:pragma shader_feature_local _NORMALMAP
		*/
